...
@section('content')
    ...
    <div class="pb-2 px-2 px-sm-5 mx-xl-4">
        <div class="progress cursor-pointer" role="progressbar" aria-label="{{\App\CPU\translate('Grofresh Software Installation')}}"
             aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" data-bs-toggle="tooltip"
             data-bs-placement="top" data-bs-custom-class="custom-progress-tooltip" data-bs-title="{{\App\CPU\translate('Intro Step')}}!"
    ...
    <div class="card mt-4">
        <div class="p-4 my-md-3 mx-xl-4 px-md-5">
            <p class="text-center mb-4 top-info-text">{{\App\CPU\translate('Before starting the installation process please collect this
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex gap-4 align-items-center flex-wrap">
                                <img
                                    ...
                                    alt="">
                                <div>{{\App\CPU\translate('Database Name')}}</div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex gap-4 align-items-center flex-wrap">
                                <img
                                    ...
                                    alt="">
                                <div>{{\App\CPU\translate('Database Password')}}</div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex gap-4 align-items-center flex-wrap">
                                <img
                                    ...
                                    alt="">
                                <div>{{\App\CPU\translate('Database Username')}}</div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex gap-4 align-items-center flex-wrap">
                                <img
                                    ...
                                    alt="">
                                <div>{{\App\CPU\translate('Database Host Name')}}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-center">
                <p>{{\App\CPU\translate('Are you ready to start installation process')}} ?</p>

                <a href="{{ route('step1',['token'=>bcrypt('step_1')]) }}" class="btn btn-dark px-sm-5">
                    {{\App\CPU\translate('Get Started')}}</a>
            </div>
        </div>
    </div>
@endsection
