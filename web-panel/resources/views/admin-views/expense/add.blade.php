...
@section('content')
    <div class="content container-fluid">
        <div class="row align-items-center mb-3">
            <div class="col-sm mb-2 mb-sm-0">
                <h1 class="page-header-title d-flex align-items-center g-2px text-capitalize"><i
                    ...
                    <span>{{ \App\CPU\translate('add_new_expense') }}</span>
                </h1>
            </div>
        </div>
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.account.store-expense') }}" method="post" id="store-or-update-data">
                            <div class="row pl-2">
    ...
    <div class="content container-fluid">
        ...
        @include('layouts.admin.table._card', [
                                                'resources' => $expenses,
                                                'tableFor' => 'new-expense',
                                                'searchBoxPlaceholder' => \App\CPU\translate('search_by_account'),
                                                'columns' => ['date', 'account', 'type', 'amount', 'description', 'debit', 'credit', 'balance'],
                                                'tableRows' => view('admin-views.expense.partials._table-rows',['expenses' => $expenses])->render(),
                                                'exportRoute' => route('admin.account.export-expense')])
    </div>
@endsection
