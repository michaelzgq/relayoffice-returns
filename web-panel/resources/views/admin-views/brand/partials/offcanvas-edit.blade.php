<div class="offcanvas-filter__header d-flex justify-content-between align-items-start border-bottom px-2 py-2">
    <div class="pl-3 py-2">
        <h4 class="title mb-0">{{ \App\CPU\translate('Edit Brand') }}</h4>
    </div>
...
<form action="{{ route('admin.brand.update', $resource->id) }}" method="post" enctype="multipart/form-data" id="store-or-update-data">
        ...
        <div class="mb-80">
            <div class="form-group d-flex justify-content-between align-items-center gap-3 flex-wrap">
                <h5 class="mb-0 flex-grow-1 d-flex gap-1">{{ \App\CPU\translate('Availability') }}<i
                        ...
                        data-original-title="{{ \App\CPU\translate('If the availability status turned off, this brand and all the products under this brand will not show in the POS') }}"></i></h5>
                    <label
            ...
            <div class="bg-fafafa p-3 p-lg-4 rounded-10 mb-4">
                <div class="form-group">
                    <label for="" class="title d-flex g-2px">{{ \App\CPU\translate('Brand Name') }}<span
                    ...
                    <label class="upload-file" data-image-id="">
                        ...
                        <div class="upload-file-wrapper w-100px">
                            ...
                            <img class="upload-file-img" loading="lazy"
                                 src="{{ onErrorImage($resource->image,asset('storage/brand/' . $resource->image),'', 'brand') }}"
                                 data-default-src="{{ onErrorImage($resource->image,asset('storage/brand/' . $resource->image),'', 'brand') }}"
