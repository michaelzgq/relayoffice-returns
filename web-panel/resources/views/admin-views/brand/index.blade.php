...
@section('content')
    <div class="content container-fluid">
            ...
            <div class="row align-items-center mb-3">
                <div class="col-sm">
                    <h1 class="page-header-title d-flex align-items-center g-2px text-capitalize mb-0">
                        <span>{{ \App\CPU\translate('brand_setup') }}</span>
                    </h1>
                </div>
            </div>
        </div>
        <div class="card mb-4">
            <div class="card-body">
                <div class="mb-4">
                    <h3 class="mb-0">{{ \App\CPU\translate('new_brand') }}</h3>
                    <p class="fs-12 mb-0">{{ \App\CPU\translate('Add a new brand to organize and manage your products in the POS.') }}</p>
                </div>
                <form action="{{route('admin.brand.store')}}" method="post" enctype="multipart/form-data" id="store-or-update-data">
                    <div class="row gy-3">
                        <div class="col-lg-6">
                            <div class="bg-fafafa p-3 p-lg-4 rounded-10 h-100">
                                <div class="form-group">
                                    <label for="" class="title d-flex g-2px">{{ \App\CPU\translate('brand_name') }}
                                        <span class="text-danger">*</span></label>
                                    <input type="text" name="name" class="form-control"
                                           placeholder="{{\App\CPU\translate('type_brand_name')}}">
        ...
        <div class="card">
                                    ...
                                    <div class="card card-sm">
                                        ...
                                        <div class="card-body">
                                            <div class="overflow-y-auto max-h-100vh-500px max-h-lg-100vh-400px">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <span class="mr-2 fs-13 title text-capitalize">{{ \App\CPU\translate('Brand Name') }}</span>
                                                    <label class="toggle-switch toggle-switch-sm"
            ...
            <div class="table-responsive mb-5">
                <table
                    ...
                    <tr>
                        ...
                        <th data-column="name">{{ \App\CPU\translate('brand_name') }}</th>
                        ...
                        <tr>
                            ...
                            <td data-column="name">
                                <div class="d-flex gap-2 align-items-center">
                                    <img src="{{ $resource['image_fullpath'] }}"
                            ...
                            <td data-column="action">
                                <div class="d-flex justify-content-center align-items-center gap-3">
                                    ...
                                    <button type="button"
                                            ...
                                            data-toggle="modal"
                                            data-title="{{ \App\CPU\translate('Are you sure to delete this brand') }}?"
                                            data-subtitle="{{ \App\CPU\translate('If once you delete this brand, you will lost this brand data permanently.') }}"
            ...
            @if(count($resources) ==0 )
                <div class="text-center p-4">
                    <img class="mb-3 w-two-bri" src="{{asset('assets/admin')}}/svg/illustrations/sorry.svg"
    ...
    @include('admin-views.brand.partials.offcanvas-filter')
    ...
    <span class="data-to-js"
          ...
          data-export-route="{{ route('admin.brand.export') }}"
          data-view-route="{{ route('admin.brand.render-view-canvas') }}"
          data-edit-route="{{ route('admin.brand.render-edit-canvas') }}"
          data-delete-after-shifting-route="{{ route('admin.brand.delete-after-shifting-modal') }}"
          data-delete-route="{{ route('admin.brand.delete', ':id') }}"
    >
...
@push('script_2')
    ...
    <script>
        ...
        $(document).on('click', '.brand-delete-modal-click-here', function () {
            $('.body-brand-delete').addClass('d-none');
            $('.body-brand-shift-and-delete').removeClass('d-none');
        });

        $(document).on('click', '.brand-delete-modal-go-back', function () {
            $('.body-brand-shift-and-delete').addClass('d-none');
            $('.body-brand-delete').removeClass('d-none');
        });
    </script>
@endpush
