...
--
-- Host: localhost:8889
-- Generation Time: Jul 26, 2025 at 04:34 AM
...
(1, 'Cash', 'Default account', 0, '1', 0, 0, '2021-11-28 05:06:59', '2021-12-01 08:11:58', NULL),
(2, 'Payable', 'td', 0, '2', 0, 0, '2021-11-28 05:07:21', '2021-12-01 05:02:22', NULL),
(3, 'Receivable', 'Default account', 0, '3', 0, 0, '2021-11-28 05:07:36', '2021-12-01 08:11:58', NULL);
...
INSERT INTO `brands` (`id`, `name`, `description`, `status`, `image`, `created_at`, `updated_at`, `company_id`) VALUES
(3, 'Test Brand', NULL, 1, '2023-10-25-65389205947d0.png', '2023-10-25 03:56:53', '2023-10-25 03:56:53', NULL);
...
INSERT INTO `categories` (`id`, `name`, `description`, `parent_id`, `position`, `status`, `image`, `created_at`, `updated_at`, `company_id`) VALUES
(1, 'Test Category', NULL, 0, 0, 1, '2023-10-25-653891d1a698a.png', '2023-10-25 03:56:01', '2023-10-25 03:56:01', NULL),
(2, 'Test Sub Category', NULL, 1, 1, 1, 'def.png', '2023-10-25 03:56:25', '2023-10-25 03:56:25', NULL);
...
CREATE TABLE `companies` (
  ...
  `sub_domain_prefix` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(0, 'Walk-In Customer', '1', NULL, 'def.png', NULL, NULL, NULL, NULL, 0, '2021-11-28 05:37:48', '2021-11-28 05:37:48', NULL);
...
(48, '2024_09_24_132001_create_counters_table', 7),
(49, '2024_09_24_161729_add_counter_id_in_orders_table', 7),
(50, '2025_01_27_171536_add_order_status_to_orders_table', 8),
(51, '2025_01_30_164219_create_refunds_table', 8),
(52, '2025_06_24_101316_add_description_in_categories_table', 9),
(53, '2025_07_03_114849_add_description_reorder_level_status_available_time_started_at_available_time_ended_at_to_products_table', 9),
(54, '2025_07_03_115731_add_description_status_to_brands_table', 9),
(55, '2025_07_06_162913_add_status_to_units_table', 9),
(56, '2025_07_09_154520_make_image_column_nullable_in_categories_table', 9),
(57, '2025_07_09_161537_make_image_column_nullable_in_brands_table', 9),
(58, '2025_07_14_102519_add_admin_payment_method_customer_payout_method_other_payment_details_to_refunds_table', 9),
(59, '2025_07_23_133254_rename_walking_customer_to_walk_in_customer_in_customers_table', 9);
...
CREATE TABLE `orders` (
  ...
  `email_or_phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `order_status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'completed'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `products` (
  ...
  `reorder_level` smallint UNSIGNED NOT NULL DEFAULT '1',
  `status` smallint UNSIGNED NOT NULL DEFAULT '1' COMMENT '0: Inactive, 1: Active',
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `order_count` int UNSIGNED DEFAULT NULL,
  `supplier_id` int UNSIGNED DEFAULT NULL,
  `available_time_started_at` time DEFAULT NULL,
  `available_time_ended_at` time DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `company_id` bigint DEFAULT NULL
...
INSERT INTO `products` (`id`, `name`, `description`, `product_code`, `unit_type`, `unit_value`, `brand`, `category_ids`, `purchase_price`, `selling_price`, `discount_type`, `discount`, `tax`, `quantity`, `reorder_level`, `status`, `image`, `order_count`, `supplier_id`, `available_time_started_at`, `available_time_ended_at`, `created_at`, `updated_at`, `company_id`) VALUES
(1, 'Test Product', NULL, '74982', 1, 1.00, '3', '[{\"id\":\"1\",\"position\":1},{\"id\":\"2\",\"position\":2}]', 70, 100, 'percent', 0.00, 0.00, 80, 1, 1, '2023-10-25-65389342b5f12.png', 0, 1, NULL, NULL, '2023-10-25 04:02:10', '2023-10-25 04:02:24', NULL);
...
CREATE TABLE `refunds` (
  ...
  `admin_payment_method_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `admin_payment_method_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_payout_method_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `other_payment_details` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `transections` (
  `id` bigint UNSIGNED NOT NULL,
  `tran_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `units` (`id`, `unit_type`, `status`, `created_at`, `updated_at`, `company_id`) VALUES
(1, 'kg', 1, '2021-11-28 05:34:53', '2021-11-28 05:34:53', NULL),
(2, 'Ltr', 1, '2021-11-28 05:35:05', '2021-11-28 05:35:05', NULL),
(3, 'Pc', 1, '2021-11-28 05:35:14', '2021-11-28 05:35:14', NULL);
